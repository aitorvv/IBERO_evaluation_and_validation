...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_mortalidad_sdi/plots_IFN_iberops_mortalidad_sdi.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=iberops.plots_IFN_iberops_mortalidad_sdi;
	GETNAMES=YES;
RUN;

/*Establezco la ruta de la librería*/
libname iberops'/home/u47544240/IBEROps/';

/*Selecciono las variables a comparar*/
data datos;
set iberops.plots_IFN_iberops_mortalidad_sdi;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
set datos;
error=y2-y1;
if y2=0 or y1='NA' or y2='NA' then delete;
run;

/*Establezco la salida del pdf y activo los gráficos*/
options pagesize=max;
ods pdf file="/home/u47544240/IBEROps/outputs_mortalidad_sdi/Ho_mortalidad_sdi.pdf";
ods graphics on;
