...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_mortalidad/plots_IFN_iberops_mortalidad.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=iberops.plots_IFN_iberops_mortalidad;
	GETNAMES=YES;
RUN;
...
data datos;
set iberops.plots_IFN_iberops_mortalidad;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROps/outputs_mortalidad/Ho_mortalidad.pdf";
ods graphics on;
