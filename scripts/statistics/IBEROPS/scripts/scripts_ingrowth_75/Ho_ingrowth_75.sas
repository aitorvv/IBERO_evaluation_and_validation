...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_ingrowth_75/plots_IFN_iberops_ingrowth_75.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=iberops.plots_IFN_iberops_ingrowth_75;
	GETNAMES=YES;
RUN;
...
data datos;
set iberops.plots_IFN_iberops_ingrowth_75;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROps/outputs_ingrowth_75/Ho_ingrowth_75.pdf";
ods graphics on;
