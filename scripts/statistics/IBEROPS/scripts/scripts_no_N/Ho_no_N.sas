...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_no_N/plots_IFN_iberops_no_N.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=iberops.plots_IFN_iberops_no_N;
	GETNAMES=YES;
RUN;
...
data datos;
set iberops.plots_IFN_iberops_no_N;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROps/outputs_no_N/Ho_no_N.pdf";
ods graphics on;
