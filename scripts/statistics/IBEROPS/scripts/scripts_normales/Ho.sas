...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_normales/plots_IFN_iberops.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=IBEROps.plots_IFN_iberops;
	GETNAMES=YES;
RUN;
...
ods pdf file="/home/u47544240/IBEROps/outputs_normales/Ho.pdf";
ods graphics on;
