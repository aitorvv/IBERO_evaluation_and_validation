...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_calibrado_dbh/plots_IFN_iberops_calibrado_dbh.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=IBEROps.plots_IFN_iberops_calibrado_dbh;
	GETNAMES=YES;
RUN;
...
data datos;
set IBEROps.plots_IFN_iberops_calibrado_dbh;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROps/outputs_calibrado_dbh/Ho.pdf";
ods graphics on;
