...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_calibrado_dbh/trees_IFN_iberops_calibrado_dbh.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=IBEROps.trees_IFN_iberops_calibrado_dbh;
	GETNAMES=YES;
RUN;
...
data datos;
set IBEROps.trees_IFN_iberops_calibrado_dbh;
y1=dbh_IFN2;
y2=dbh_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROps/outputs_calibrado_dbh/dbh.pdf";
ods graphics on;
