...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_ingrowth_25/plots_IFN_iberops_ingrowth_25.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=iberops.plots_IFN_iberops_ingrowth_25;
	GETNAMES=YES;
RUN;
...
data datos;
set iberops.plots_IFN_iberops_ingrowth_25;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROps/outputs_ingrowth_25/Ho_ingrowth_25.pdf";
ods graphics on;
