...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_calibrado_dbh_h/trees_IFN_iberops_cal_dbh_h.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=IBEROps.trees_IFN_iberops_cal_dbh_h;
	GETNAMES=YES;
RUN;
...
data datos;
set IBEROps.trees_IFN_iberops_cal_dbh_h;
y1=dbh_IFN2;
y2=dbh_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROps/outputs_calibrado_dbh_h/dbh.pdf";
ods graphics on;
