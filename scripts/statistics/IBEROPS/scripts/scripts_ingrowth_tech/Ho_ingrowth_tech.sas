...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_ingrowth_tech/plots_IFN_iberops_ingrowth_tech.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=iberops.plots_IFN_iberops_ingrowth_tech;
	GETNAMES=YES;
RUN;
...
data datos;
set iberops.plots_IFN_iberops_ingrowth_tech;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROps/outputs_ingrowth_tech/Ho_ingrowth_tech.pdf";
ods graphics on;
