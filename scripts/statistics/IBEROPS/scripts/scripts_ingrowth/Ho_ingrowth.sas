...
FILENAME REFFILE '/home/u47544240/IBEROps/datos_ingrowth/plots_IFN_iberops_ingrowth.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=iberops.plots_IFN_iberops_ingrowth;
	GETNAMES=YES;
RUN;
...
data datos;
set iberops.plots_IFN_iberops_ingrowth;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROps/outputs_ingrowth/Ho_ingrowth.pdf";
ods graphics on;
