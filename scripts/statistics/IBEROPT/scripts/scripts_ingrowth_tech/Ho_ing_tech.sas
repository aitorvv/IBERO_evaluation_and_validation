...
FILENAME REFFILE '/home/u47544240/IBEROpt/datos_ingrowth_tech/plots_IFN_iberopt_ing_tech.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=iberopt.plots_IFN_iberopt_ingrowth_tech;
	GETNAMES=YES;
RUN;

/*Establezco la ruta de la librería*/
libname iberopt'/home/u47544240/IBEROpt/';

/*Selecciono las variables a comparar*/
data datos;
set iberopt.plots_IFN_iberopt_ingrowth_tech;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROpt/outputs_ingrowth_tech/Ho_ingrowth_tech.pdf";
ods graphics on;
