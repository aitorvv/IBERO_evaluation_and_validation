...
FILENAME REFFILE '/home/u47544240/TFM/datos_calibrado_dbh/plots_IFN_iberopt_calibrado_dbh.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=TFM.plots_IFN_iberopt_calibrado_dbh;
	GETNAMES=YES;
RUN;
...
data datos;
set TFM.plots_IFN_iberopt_calibrado_dbh;
y1=G_incorporada_IFN2;
y2=G_incorporada_IFN3;
run;
...
ods pdf file="/home/u47544240/TFM/outputs_calibrado_dbh/G_incorporada_calibrado_dbh.pdf";
ods graphics on;
