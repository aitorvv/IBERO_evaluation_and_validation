...
FILENAME REFFILE '/home/u47544240/TFM/datos_normales/trees_IFN_iberopt.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=TFM.trees_IFN_iberopt;
	GETNAMES=YES;
RUN;
...
ods pdf file="/home/u47544240/TFM/outputs_normales/dbh_i.pdf";
ods graphics on;
