...
FILENAME REFFILE '/home/u47544240/TFM/datos_normales/plots_IFN_iberopt.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=TFM.plots_IFN_iberopt;
	GETNAMES=YES;
RUN;
...
ods pdf file="/home/u47544240/TFM/outputs_normales/G_incorporada.pdf";
ods graphics on;
