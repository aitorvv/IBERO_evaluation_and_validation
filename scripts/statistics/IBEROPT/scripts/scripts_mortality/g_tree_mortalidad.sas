...
FILENAME REFFILE '/home/u47544240/TFM/datos_mortalidad/trees_IFN_iberopt_mortalidad.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=TFM.trees_IFN_iberopt_mortalidad;
	GETNAMES=YES;
RUN;
...
data datos;
set TFM.trees_IFN_iberopt_mortalidad;
y1=g_IFN2;
y2=g_IFN3;
run;
...
ods pdf file="/home/u47544240/TFM/outputs_mortalidad/g_tree_mortalidad.pdf";
ods graphics on;
