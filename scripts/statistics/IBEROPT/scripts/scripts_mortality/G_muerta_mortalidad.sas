...
FILENAME REFFILE '/home/u47544240/TFM/datos_mortalidad/plots_IFN_iberopt_mortalidad.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=TFM.plots_IFN_iberopt_mortalidad;
	GETNAMES=YES;
RUN;
...
data datos;
set TFM.plots_IFN_iberopt_mortalidad;
y1=G_muerta_IFN2;
y2=G_muerta_IFN3;
run;
...
ods pdf file="/home/u47544240/TFM/outputs_mortalidad/G_muerta_mortalidad.pdf";
ods graphics on;
