...
FILENAME REFFILE '/home/u47544240/TFM/datos_ingrowth_50/plots_IFN_iberopt_ingrowth_50.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=TFM.plots_IFN_iberopt_ingrowth_50;
	GETNAMES=YES;
RUN;
...
data datos;
set TFM.plots_IFN_iberopt_ingrowth_50;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/TFM/outputs_ingrowth_50/Ho_ingrowth_50.pdf";
ods graphics on;
