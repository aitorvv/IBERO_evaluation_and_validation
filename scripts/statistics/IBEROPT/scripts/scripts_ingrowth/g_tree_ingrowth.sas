...
FILENAME REFFILE '/home/u47544240/TFM/datos_ingrowth/trees_IFN_iberopt_ingrowth.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=TFM.trees_IFN_iberopt_ingrowth;
	GETNAMES=YES;
RUN;
...
data datos;
set TFM.trees_IFN_iberopt_ingrowth;
y1=g_IFN2;
y2=g_IFN3;
run;
...
ods pdf file="/home/u47544240/TFM/outputs_ingrowth/g_tree_ingrowth.pdf";
ods graphics on;
