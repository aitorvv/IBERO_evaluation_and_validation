...
FILENAME REFFILE '/home/u47544240/TFM/datos_ingrowth/plots_IFN_iberopt_ingrowth.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=TFM.plots_IFN_iberopt_ingrowth;
	GETNAMES=YES;
RUN;
...
data datos;
set TFM.plots_IFN_iberopt_ingrowth;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/TFM/outputs_ingrowth/Ho_ingrowth.pdf";
ods graphics on;
