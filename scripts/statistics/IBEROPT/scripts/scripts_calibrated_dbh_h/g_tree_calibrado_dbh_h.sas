...
FILENAME REFFILE '/home/u47544240/TFM/datos_calibrado_dbh_h/trees_IFN_iberopt_calibrado_dbh_h.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=cdh.trees_IFN_iberopt;
	GETNAMES=YES;
RUN;
...
ods pdf file="/home/u47544240/TFM/outputs_calibrado_dbh_h/g_tree_calibrado_dbh_h.pdf";
ods graphics on;
