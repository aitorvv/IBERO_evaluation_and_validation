...
FILENAME REFFILE '/home/u47544240/IBEROpt/datos_no_N/plots_IFN_iberopt_no_N.csv';

PROC IMPORT DATAFILE=REFFILE
	DBMS=CSV
	OUT=iberopt.plots_IFN_iberopt_no_N;
	GETNAMES=YES;
RUN;
...
data datos;
set iberopt.plots_IFN_iberopt_no_N;
y1=Ho_IFN2;
y2=Ho_IFN3;
run;
...
ods pdf file="/home/u47544240/IBEROpt/outputs_no_N/Ho_no_N.pdf";
ods graphics on;
